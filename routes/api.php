...
Route::middleware('auth:sanctum')->get('/users/me', [DashboardAdminUserController::class, 'me']);
...
Route::get('dashboard/tickets/priority-stats', [TicketStatsController::class, 'getPriorityStats']);
